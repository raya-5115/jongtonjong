export default function VisiMisiSection({ profile }) {
  const vision =
    profile?.vision ||
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-12 lg:gap-16">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-slate-700 max-w-md whitespace-pre-line">
              {vision}
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            {missionLines.length > 1 ? (
              <ul className="mt-4 text-sm sm:text-base leading-relaxed text-slate-700 max-w-md text-left space-y-2 list-disc list-inside">
